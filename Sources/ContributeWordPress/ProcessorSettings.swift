...
@available(*, deprecated, renamed: "ProcessorSettings")
public typealias WordPressMarkdownProcessorSettings = ProcessorSettings
...
extension ProcessorSettings {
  public var resourceAssetPathURL: URL {
    return self.resourcesPathURL.appendingPathComponent(assetRelativePath)
  }
  ...
  public func htmlFromPost(_ site: WordPressSite) -> ((WordPressPost) -> String) {
    let assetPostURLSearchPrefix = site.baseURL.appendingPathComponent(self.uploadsRelativePath).absoluteString
    return { post in
