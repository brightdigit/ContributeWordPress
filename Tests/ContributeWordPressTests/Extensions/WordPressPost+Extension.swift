...
extension WordPressPost {
    static func myYearInReviewPost(tags: [RSSItemCategory]? = nil) throws -> WordPressPost {
        try make(
    ...
    static func areWeThereYetPost(tags: [RSSItemCategory]? = nil) throws -> WordPressPost {
        try make(
    ...
    static func fromGoalsToActionsPost(tags: [RSSItemCategory]? = nil) throws -> WordPressPost {
        try make(
    ...
    static func podcastingPost(tags: [RSSItemCategory]? = nil) throws -> WordPressPost {
        try make(
    ...
    static func productivityAppsPost(tags: [RSSItemCategory]? = nil) throws -> WordPressPost {
        try make(
