...
internal final class DynamicRedirectGeneratorTests: XCTestCase {
    ...
    func testEmptySiteShouldGenerateNoRedirects() throws {
    ...
    func testOneSiteWithSomeNumberOfPostsShouldGenerateSameNumberOfRedirects() throws {
    ...
    private func testThenAssertRedirect(fromSites allSites: [SectionName : WordPressSite]) {
        let tuples: [(WordPressPost, SectionName)] = allSites
            ...
            .flatMap { $0 }
        let allPosts: [WordPressPost] = tuples.map { $0.0 }
    ...
    func testMultipleSitesEachWithNumberOfPostsShouldGenerateSameNumberOfRedirectsPerSite() throws {
    ...
    private func generateUrlPath(fromName name: String, wordpressPost post: WordPressPost) -> String {
