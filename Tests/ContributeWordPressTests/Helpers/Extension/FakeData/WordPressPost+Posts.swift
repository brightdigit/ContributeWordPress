...
extension WordPressPost {
  internal static func myYearInReviewPost(
    ...
    try make(
      ...
      link: URL(staticString: "https://leogdion.name/2019/01/14/2018-review/"),
      description: [
  ...
  internal static func areWeThereYetPost(
    ...
    try make(
      ...
      link: URL(staticString: "https://leogdion.name/2018/12/13/are-we-there-yet/"),
  ...
  internal static func fromGoalsToActionsPost(
    ...
    try make(
      ...
      link: URL(staticString: "https://leogdion.name/2018/01/08/from-goals-to-actions-2018/diagram-for-goals/"
      ),
  ...
  internal static func podcastingPost(
    ...
    try make(
      ...
      link: URL(
        ...
        staticString: "https://leogdion.name/2019/06/13/podcasting-getting-started-content-recording-audience/"
      ),
      description: [
  ...
  internal static func productivityAppsPost(
    ...
    try make(
      ...
      link: URL(staticString: "https://leogdion.name/2019/08/01/productivity-apps-for-developers-and-everyone/"
      ),
      description: [
